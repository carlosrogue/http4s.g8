...
1. [Install sbt](http://www.scala-sbt.org/1.0/docs/Setup.html) or [mill](https://mill-build.org/mill/cli/installation-ide.html) or [scala-cli](https://scala-cli.virtuslab.org/install)
